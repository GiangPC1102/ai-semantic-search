...
async def embed_hybrid_documents(texts: List[str] = Body(..., embed=True)) -> List[EmbedHybridResponse]:
    ...
    try:
        result = await asyncio.to_thread(
            client.embed_hybrid_documents, texts, settings.EMBEDDING_SERVICE_MODEL)
